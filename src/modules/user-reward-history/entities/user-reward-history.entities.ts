...
export const CreateUserRewardHistoryBodySchema = CreateUserRewardHistoryBodySchemaBase.refine(
...
export const GetUserRewardHistoryListQuerySchema = z
    .object({
        ...
        rewardId: z.string().transform((val) => parseInt(val, 10)).optional(),
        sourceType: UserRewardSourceTypeSchema.optional(),
        rewardTargetSnapshot: RewardTargetSchema.optional(),
...
export type CreateUserRewardHistoryBodyType = z.infer<typeof CreateUserRewardHistoryBodySchema>
export type UpdateUserRewardHistoryBodyType = z.infer<typeof UpdateUserRewardHistoryBodySchema>
...
export type GetUserRewardHistoryByIdParamsType = z.infer<typeof GetUserRewardHistoryByIdParamsSchema>
export type GetUserRewardHistoryListQueryType = z.infer<typeof GetUserRewardHistoryListQuerySchema>
